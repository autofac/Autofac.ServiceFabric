...
using Moq;
using Test.Scenario.InternalsVisible.Services;
using Xunit;
...
namespace Autofac.Integration.ServiceFabric.Services.Test
{
    public sealed class AutofacServiceExtensionsTests
    {
        ...
        //    Assert.Contains(new TypedService(typeof(ServiceInterceptor)), (IEnumerable<Service>)interceptorServices);
        //}
        ...
        //    var result = interceptorServices.Contains(new TypedService(typeof(ServiceInterceptor)));
